package org.liu.store;

import com.google.common.collect.Maps;
import lombok.Getter;
import lombok.extern.slf4j.Slf4j;
import org.liu.block.entity.Block;
import org.liu.transaction.TransactionOutput;
...
public class RocksDBUtils {
    ...
    public void putBlock(Block block) {
        try {
            blocksBucket.put(block.getBlockHadeHash(), SerializeUtils.serialize(block));
            db.put(SerializeUtils.serialize(BLOCKS_BUCKET_KEY), SerializeUtils.serialize(blocksBucket));
        } catch (RocksDBException e) {
     ...
     * @param utxos UTXOs
     */
    public void putUTXOs(String key, TransactionOutput[] utxos) {
        try {
